...
url_new = "https://elearning.tgm.ac.at/pluginfile.php/1548/user/icon/lambda/f3"
...
print(s)
id = s[4]
print(f"https://elearning.tgm.ac.at/pluginfile.php/{url.split('/')[4]}/user/icon/lambda/f3")
